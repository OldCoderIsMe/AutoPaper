...
# Add claude-skills root to path so "shared" package is importable
_claude_skills_root = Path(__file__).resolve().parent.parent.parent
sys.path.insert(0, str(_claude_skills_root))
